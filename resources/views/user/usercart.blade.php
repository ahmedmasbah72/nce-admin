...
<body>
    <nav class="navbar navbar-expand-lg">
        <div class="container-fluid">
            <a class="navbar-brand" href="{{route('user.view')}}">
        ...
        <table class="table">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <form action="{{ route('usercart.update') }}" method="POST">
                            @csrf
                    ...
                    <td>
                            <input type="number" name="discount" value="{{ $details['discount'] ?? 0 }}" class="form-control discount" step="0.01" min="0" max="10">
                    </td>
                    <td class="item-total">
                    ...
                    <td>
                        ...
                        <form action="{{ route('usercart.remove') }}" method="POST">
                            @csrf
                            <input type="hidden" name="id" value="{{ $id }}">
        ...
        document.addEventListener('DOMContentLoaded', function () {
            ...
            function updateTotal() {
                ...
                document.querySelectorAll('tbody tr').forEach(function (row) {
                    ...
                    if (discount > 10) {
                        discount = 10;
                        row.querySelector('.discount').value = 10;
                        alert("La remise ne peut pas dépasser 10%.");
                    }
