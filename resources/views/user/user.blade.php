    ...
    <nav class="navbar navbar-expand navbar-dark navbar-toggler">
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                ...
                <a href="{{ route('usercart.index') }}" class="btn btn-danger ms-3 mt-2 mt-sm-0" id="cart-btn">
            ...
            <tbody>
                @foreach($people as $person)
                    <tr class="table">
                        ...
                        <td>
                            <form action="{{ route('usercart.add', $person->id) }}" method="POST">
                                @csrf
                                <button type="submit" id="cart-btn">Ajouter au panier</button>
                            </form>
                        </td>
