...
<body>    
    ...
    <div class="page-container">
                ...
                <table class="table table-bordered">
                    ...
                    <tbody>
                        ...
                        <?php
                            ...
                            $priceAfterDiscount = $details['price'] - ($details['price'] * $discount / 100);
                            $lineTotalHT = $details['quantity'] * $priceAfterDiscount;
                        ...
                        <tr>
                            <td>
                                <img src="{{ ('images/' . $details['photo']) }}" alt="Photo de {{ $details['name'] }}" width="50">
                            </td>
                            <td>{{ $details['name'] }}</td>
                            <td>{{ $details['quantity'] }}</td>
                            <td>{{ $details['price'] }}</td>
                            <td>{{ $discount }}</td>
                            <td>{{ number_format($lineTotalHT, 2) }}</td>
                            <td>{{ number_format($lineTotalTTC, 2) }}</td>
                        </tr>
                        @endforeach
                    </tbody>
                </table>
        ...
        <footer>
            <div>
                <p>New Concept Equipements SARL, ICE : 000080826000004, RC : 194285, Taxe Professionnelle : 32290139, IF : 1110549, CNSS: 7990775 <br>
                Adresse : 91-93 Rue Chaouia (Ex-Colbert) Derb Omar CASABLANCA - Maroc <br>
                Tel : 05 22 47 25 45 - Téléphone : 06 61 19 97 11 -Mail : Newequipement.2015@gmail.com </p>
            </div>
        </footer>
    </div>
