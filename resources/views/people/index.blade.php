        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    <li class="nav-item">
                        <a class="nav-link active" aria-current="page">Marques</a>
                    </li>
                    <li class="nav-item">
                ...
                <form class="d-flex">
                    <input class="form-control me-2" type="search" name="search" placeholder="Vous recherchez ..." aria-label="Search" id="search" value="{{ request()->input('search') }}">
                    <button class="button-search" type="submit">
                        <i class="fas fa-search"></i> Rechercher
                    </button>
                </form>
                <a href="{{ route('cart.index') }}" class="btn btn-danger ms-3" id="cart-btn">
            ...
            <tbody>
                @foreach($people as $person)
                    <tr class="table">
                        ...
                        <td>
                            <a class="btn" id="btn_show" href="people/Show/{{$person->id}}">
                        ...
                        <td>
                            <form action="{{ route('cart.add', $person->id) }}" method="POST">
                                @csrf
