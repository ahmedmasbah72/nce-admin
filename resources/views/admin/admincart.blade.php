    ...
    <nav class="navbar navbar-expand-lg">
        <div class="container-fluid">
            <a class="navbar-brand" href="{{ route('admin.view') }}">
                <img src="{{ asset('images/NCE_logo2.png') }}" alt="" id="img2">
            </a>
        ...
        <table class="table">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <form action="{{ route('admincart.update') }}" method="POST">
                            @csrf
...
<footer class="d-none d-md-block">
    <p>© 2024 NCE DEV - New Concept Equipement <br> All rights Reserved</p>
</footer>
</html>
